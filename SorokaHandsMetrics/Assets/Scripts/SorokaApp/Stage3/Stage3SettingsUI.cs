...
public class Stage3SettingsUI : MonoBehaviour {

    [Header("Menu Controller")]
    [SerializeField] private RehabMenuController rehabMenuController;

    [Header("Stage 1 Runtime")]
    [SerializeField] private Stage3CycleController Stage3CycleController;
    [SerializeField] private Transform Stage3ObjectsParent;
    ...
    [SerializeField] private Stage3Config currentConfig = new Stage3Config();
    ...
    public void StartStage3() {
        ...
        if (Stage3CycleController != null) {
            Stage3CycleController.BeginStage(currentConfig, Stage3ObjectsParent, selectedSkeleton);
        }
        else {
            FileLogger.Log("Stage3CycleController NOT assigned!");
        }

        if (rehabMenuController != null) {
            rehabMenuController.StartStage3();
        }
    }
