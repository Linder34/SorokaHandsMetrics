...
public class Stage3HandDataLogger : MonoBehaviour {
    [Header("Subject")]
    [SerializeField] private int subjectId = 1;

    [Header("CSV Files")]
    [SerializeField] private string resultsFileName = "Stage3_results.csv";
    [SerializeField] private string trajectoryFileName = "Stage3_hand_trajectory.csv";
    ...
    public void BeginSession(Stage3Config stageConfig, OVRSkeleton skeleton) {
        config = stageConfig;
        ...
        FileLogger.Log($"Stage3HandDataLogger: BeginSession sessionId={sessionId}");
    }
    ...
    public void BeginCycle(int cycleIndex, GameObject targetObject) {
        ...
        FileLogger.Log($"Stage3HandDataLogger: BeginCycle cycle={cycleIndex}, object={currentObjectName}");
    }
    ...
    public void EndCycle(string result, float totalTimeSeconds, float maxContinuousTouchSeconds) {
        ...
        FileLogger.Log($"Stage3HandDataLogger: EndCycle cycle={currentCycleIndex}, result={result}");
    }
    ...
    public void EndSessionScore(int score, int totalCycles) {
        ...
        FileLogger.Log(
            $"Stage3HandDataLogger: Session score saved | Score={score}, Total={totalCycles}, SuccessRate={successRate:F1}%"
        );
    }
