...
public class Stage2HandDataLogger : MonoBehaviour {
    [Header("Subject")]
    [SerializeField] private int subjectId = 1;

    [Header("CSV Files")]
    [SerializeField] private string resultsFileName = "stage2_results.csv";
    [SerializeField] private string trajectoryFileName = "stage2_hand_trajectory.csv";
    ...
    public void BeginSession(Stage2Config stageConfig, OVRSkeleton skeleton) {
        config = stageConfig;
        ...
        FileLogger.Log($"Stage2HandDataLogger: BeginSession sessionId={sessionId}");
    }
    ...
    public void BeginCycle(int cycleIndex, GameObject targetObject) {
        ...
        FileLogger.Log($"Stage2HandDataLogger: BeginCycle cycle={cycleIndex}, object={currentObjectName}");
    }
    ...
    public void EndCycle(string result, float totalTimeSeconds, float maxContinuousTouchSeconds) {
        ...
        FileLogger.Log($"Stage2HandDataLogger: EndCycle cycle={currentCycleIndex}, result={result}");
    }
    ...
    public void EndSessionScore(int score, int totalCycles) {
        ...
        FileLogger.Log(
            $"Stage2HandDataLogger: Session score saved | Score={score}, Total={totalCycles}, SuccessRate={successRate:F1}%"
        );
    }
